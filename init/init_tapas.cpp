...
void load_redmi_properties(string hwname) {
    ...
    if (hwname == "tapas") {
        ...
        fingerprint = "Redmi/tapas_global/tapas:15/AQ3A.240829.003/OS2.0.205.0.VMTMIXM:user/release-keys";
        description = "tapas_global-user 15 AQ3A.240829.003 OS2.0.205.0.VMTMIXM release-keys";
    } else if (hwname == "topaz") {
        device_name = "topaz";
        model = "23021RAA2Y";
        mod_device = "topaz_global";
        fingerprint = "Redmi/topaz_global/topaz:15/AQ3A.240829.003/OS2.0.204.0.VMGMIXM:user/release-keys";
        description = "tapas_global-user 15 AQ3A.240829.003 OS2.0.204.0.VMGMIXM release-keys";
    }
